...
export const theme = (() => {
  ...
  const themeColors = {
    // Key: Background -> Value: Text/Contrast
    "#C63E4E": "#F5F9E5", // Dark background (Calypso Berry) -> Light text
    "#F5F9E5": "#C63E4E", // Light background (Amnesiac White) -> Dark text
    "#212529": "#F5F9E5", // Secondary Dark -> Light text
    "#f8f9fa": "#C63E4E", // Secondary Light -> Dark text
  };

  const themeLight = ["#F5F9E5", "#f8f9fa"];
  const themeDark = ["#C63E4E", "#212529"];
