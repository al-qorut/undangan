...
export const guest = (() => {
  ...
  const buildGoogleCalendar = () => {
    ...
    const data = new URLSearchParams({
      action: "TEMPLATE",
      text: "The Wedding of Yandi and Ratu",
      dates: `${formatDate("2026-04-12 10:00")}/${formatDate("2026-04-12 11:00")}`,
      details:
      ...
      location:
        "RT 02 RW 13, Tugulaksana Desa Pagerwangi, Kec. Lembang, Kab. Bandung Barat, Jawa Barat 40392.",
      ctz: config.get("tz"),
    });
